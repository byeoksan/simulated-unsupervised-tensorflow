...
data_arg.add_argument('--input_height', type=int, default=175)
data_arg.add_argument('--input_width', type=int, default=295)
...
train_arg.add_argument('--batch_size', type=int, default=16, help='')
train_arg.add_argument('--buffer_size', type=int, default=2000, help='')
